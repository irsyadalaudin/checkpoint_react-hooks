export const moviesData = [            //  exports an array named moviesData containing multiple movie objects. Each movie object represents a movie and has properties like title, description, posterURL, and rating. The title property represents the title of the movie, the description property represents a description of the movie, the posterURL property contains the URL of the movie's poster image, and the rating property represents the rating of the movie.
    {
